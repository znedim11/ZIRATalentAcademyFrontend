export class SharedApi {
    public static GET_LOGGED_USER = 'http://172.20.20.45:8000/uaa/user/logged';
    public static GET_CHARACTERS = '/vigor/character/lovs';
    public static GET_PERSONS = '/vigor/person/lovs';
    public static GET_OBJECTS = '/vigor/object/lovs';
